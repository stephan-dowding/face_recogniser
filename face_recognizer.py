...
#             print "{} is Correctly Recognized with confidence unknown".format(nbr_actual)
#         else:
#             print "{} is Incorrect Recognized as {}, with confidence unknown".format(nbr_actual, nbr_predicted)
...
while True:
    try:
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.putText(frame, "{}".format(nbr_predicted), (x+5, y+20), cv2.FONT_HERSHEY_PLAIN, 1.2, (0, 255, 0), 2)
